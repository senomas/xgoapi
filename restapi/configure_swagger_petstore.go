...
import (
	...
	"github.com/senomas/xgoapi/restapi/operations"
	"github.com/senomas/xgoapi/restapi/operations/pet"
	"github.com/senomas/xgoapi/restapi/operations/store"
	"github.com/senomas/xgoapi/restapi/operations/user"
)

//go:generate swagger generate server --target ../../goapi --name SwaggerPetstore --spec ../swagger.yaml
